...
define( "RECIPIENT_NAME", "Garlin Gilchrist II" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "garlin@impetusstrategies.co" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "impetusstrategies.co contact form submission" ); //UPDATE THIS TO YOUR SUBJECT
